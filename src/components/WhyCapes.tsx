...
const features: FeatureProps[] = [
  ...
  {
    title: "96%",
    description: "of users say capes increased their efficiency",
  },
  {
    title: "88%",
    description: "of users say they saw an increase in clients",
  },
];
    ...
    <section className="py-20 bg-card rounded-[40px]" id="features">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="mx-auto max-w-4xl grid grid-rows-1 md:grid-cols-3 items-center pt-12 gap-10 md:gap-32">
            {features &&
